...
import com.legendapl.lightning.adhoc.filter.SqlserverFilterSQLImpl;
...
public class SqlserverUtils {
	...
	static {
		try {
			...
			AlertWindowService.showError("SqlserverUtils failed.", e.getMessage());
		}
	}

	public SqlserverUtils(GenericDAO dao) {
		this.dao = dao;
	}

	protected void sqlServerFilter() {
		SqlserverFilterSQLImpl filterParse = SqlserverFilterSQLImpl.getInstance();
