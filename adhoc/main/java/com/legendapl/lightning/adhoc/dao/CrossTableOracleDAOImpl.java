...
public class CrossTableOracleDAOImpl extends CrossTableGenericDAO {
	...
	public CrossTableOracleDAOImpl(Adhoc adhoc) {
		super(adhoc);
		oracleUtils.OracleFilter();
	}

	public CrossTableOracleDAOImpl(DataSourceImpl  dataSource) {
		super(dataSource);
	}
