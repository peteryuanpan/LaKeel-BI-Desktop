...
import com.legendapl.lightning.adhoc.filter.editor.MultipleValuesForBooleanEditor;
...
/**
 * データタイプと操作タイプによって、該当GeneralEditorを返す(フィルタ用)
 * 
...
public class FilterFactory {
	...
	private static GeneralEditor getBooleanEditor(Field field, OperationType opType) {
		...
		case isOneOf:
		case isNotOneOf:
			valueEditor = new MultipleValuesForBooleanEditor(field);
			break;
		default:
			throw new NoSuchOperationTypeException();
		}
